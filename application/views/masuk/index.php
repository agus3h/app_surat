   ...
   <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <div class="pull-left">
            <a href="<?=site_url('MasukController/add')?>" class="btn btn-success"><i class="fas fa-plus-square"></i>Tambah</a>
          </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>   
                       ...
                       <form action="<?=site_url('MasukController/del/'.$data->id_masuk)?>" method="post">
                       <a href="<?=site_url('MasukController/edit/'.$data->id_masuk)?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
